...
public class Tutorial3 extends JDialog implements ActionListener {
	JLabel imagem;
	...
	JPanel painel = new JPanel();
		public Tutorial3() {
			ImageIcon imagemicone = new ImageIcon(getClass().getResource("passo3.jpg"));
